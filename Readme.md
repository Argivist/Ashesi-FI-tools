# Shortcut Tools For FI use cases

This is a collection of python programs that may prove to be useful for Ashesi FI tasks.

Made to prevent repetitive tasks.
...
Stand alone python Based GUI applications for easier use by non-technical users.
